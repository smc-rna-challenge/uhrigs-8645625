...
- {class: DockerRequirement, dockerImageId: '', dockerPull: 'quay.io/smc-rna-challenge/uhrigs-8645625-smc-rna-challenge-4:1.0.0'}
id: https://cgc-api.sbgenomics.com/v2/apps/uhrigs/smc-rna-challenge-4/arriba-0-8-strict/1/raw/
inputs:
...
- class: CreateFileRequirement
  ...
  - {fileContent: "#!/bin/bash\n\nset -o pipefail\n\nif [ $# -ne 8 ]; then\n\techo\
      ...
      \ 500000 \\\n\t--alignSJstitchMismatchNmax 5 -1 5 5 --chimSegmentMin 15 --chimScoreMin\
      \ 1 --chimScoreSeparation 1 --chimScoreJunctionNonGTAG 0 --chimJunctionOverhangMin\
      \ 15 --chimSegmentReadGapMax 3 \\\n\t--limitBAMsortRAM ${MEMORY}000000 |\n\"\
      $TOOLS_DIR/extract_read-through_fusions\" -g \"$REFERENCE_GTF\" -G \"gene_name=gene_name\
      \ gene_id=gene_id transcript_id=transcript_id gene_status=gene_biotype status_KNOWN=protein_coding\
      \ gene_type=gene_biotype type_protein_coding=protein_coding feature_exon=exon\
      \ feature_UTR=UTR feature_gene=gene\" > read_through.bam || exit 1\n\n# index\
      \ normal alignments\nmv Aligned.sortedByCoord.out.bam rna.bam || exit 1\n\"\
      $TOOLS_DIR/samtools\" index rna.bam & PID_SAMTOOLS_INDEX=$!\n\n# convert chimeric\
      \ alignments from SAM to BAM\n\"$TOOLS_DIR/samtools\" view -Sb Chimeric.out.sam\
      \ > chimeric.bam & PID_SAMTOOLS_VIEW=$!\n\n# index reference genome\nautounzip\
      \ \"$REFERENCE_GENOME\" > assembly.fa || exit 1\n\"$TOOLS_DIR/samtools\" faidx\
...
sbg:createdOn: 1491758851
sbg:id: uhrigs/smc-rna-challenge-4/arriba-0-8-strict/1
sbg:image_url: null
sbg:job:
...
sbg:modifiedOn: 1491758948
sbg:project: uhrigs/smc-rna-challenge-4
sbg:projectName: smc-rna-challenge-4
sbg:revision: 1
sbg:revisionsInfo:
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1491758851, 'sbg:revision': 0, 'sbg:revisionNotes': Copy
    of uhrigs/smc-rna-challenge-4/arriba-0-8-sensitive/1}
- {'sbg:modifiedBy': uhrigs, 'sbg:modifiedOn': 1491758948, 'sbg:revision': 1, 'sbg:revisionNotes': null}
